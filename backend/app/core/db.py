...
from app.core.config import connect_args, database_url, settings
...
async def init_db() -> None:
    ...
    from app.features.identity.oidc.keys import ensure_signing_key
    from app.features.llm.services.seed import seed_llm_defaults
    from app.features.identity.services.user_seed import seed_admin_user
